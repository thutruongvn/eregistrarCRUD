...
public class StudentController {
    ...
    @GetMapping(value = {"eregistrar/student/list","/eregistrar/student/list"})
    ...
    @GetMapping(value = {"eregistrar/student/new", "/eregistrar/student/new"})
    ...
    @PostMapping(value = {"/eregistrar/student/delete"})
    public String deleteStudent(@Valid @ModelAttribute("studentId") String studentId,
                                BindingResult bindingResult, Model model) {
        studentService.deleteStudentById(Integer.parseInt(studentId));
        return "redirect:/eregistrar/student/list";
    }
